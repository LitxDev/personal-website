...
export default function Home() {
  return (
    <>
      ...
      >
        <p className="text-5xl leading-tight md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-7xl">
        ...
        <Link href="/about">
          <a className="bg-accent-500 rounded-full shadow uppercase p-2 text-2xl hover:bg-accent-400 hover:shadow-xl transition-colors transition-shadow duration-200 ease-in-out md:text-1xl lg:text-2xl xl:text-3xl 2xl:text-4xl 2xl:p-4">
            About me
          </a>
        </Link>
      </div>
