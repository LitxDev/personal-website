...
export default function Home() {
  return (
    <>
      ...
      >
        <p className="text-1xl leading-tight md:text-3xl lg:text-4xl xl:text-5xl xxl:text-7xl">
        ...
        <Link href="/about">
          <a className="bg-accent-500 rounded-full shadow uppercase p-2 text-sm hover:bg-accent-400 hover:shadow-xl transition-colors transition-shadow duration-200 ease-in-out md:text-1xl lg:text-2xl xl:text-3xl xxl:text-4xl xxl:p-4">
            About me
          </a>
        </Link>
      </div>
